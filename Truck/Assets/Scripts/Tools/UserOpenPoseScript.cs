...
public class UserOpenPoseScript : MonoBehaviour
{
    ...
    // OpenPose settings
    public OpenPose.ProducerType inputType = OpenPose.ProducerType.ImageDirectory;
    ...
    {
        OpenPose.OPWrapper.CusStart();
        //Register callbacks
        OpenPose.OPWrapper.OPRegisterCallbacks();
        OpenPose.OPWrapper.OPEnableDebug(!_editmode);
