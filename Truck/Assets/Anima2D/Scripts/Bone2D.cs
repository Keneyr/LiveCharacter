...
namespace Anima2D 
{
	public class Bone2D : MonoBehaviour
	{
        ...
        //因为我从OpenPose读出来骨骼端点(应该)就是全局变量，所以这里是全局变量
        ...
        //难道在相关引用中要把endPosition替换为globalendPosition？
		public Vector3 endPosition
		{
			get { return transform.TransformPoint(localEndPosition); } //本地坐标系到世界坐标系转换
		}

        //用的bone的length都是通过这个接口吧
