...
namespace Anima2D 
{
	...
	{	
        ...
        //在scene视图中拖动骨骼，根据鼠标点在世界（本地）坐标系下的位置，计算该bone的旋转角
		...
		{
            //Debug.Log(bone.transform.position + " , " + localPosition);
