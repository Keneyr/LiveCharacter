...
namespace Anima2D
{
	...
	public class Bone2DEditor : Editor
	{
        ...
        SerializedProperty m_StartPointPositionProperty;
        SerializedProperty m_EndPointPositionProperty;
		...
		void OnEnable()
		{
            ...
            m_StartPointPositionProperty = serializedObject.FindProperty("m_StartPointPosition");
            m_EndPointPositionProperty = serializedObject.FindProperty("m_EndPointPosition");
        }
		...
		override public void OnInspectorGUI()
		{
            ...
            EditorGUILayout.PropertyField(m_StartPointPositionProperty);
            EditorGUILayout.PropertyField(m_EndPointPositionProperty);
